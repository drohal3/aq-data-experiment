...
PATH_A = "local/recent_1m_all_attr"

data_dynamo_a = []
with open(f'{PATH_A}/DynamoDBRetriever_1m.txt', 'r') as file:
...
data_kinesis_a = []
with open(f'{PATH_A}/KinesisRetriever_1m.txt', 'r') as file:
    # Read each line in the file
    for line in file:
        # Strip newline characters and print each line
        json_line = json.loads(line)
...
data_timestream_a = []
with open(f'{PATH_A}/TimestreamDBRetriever_1m.txt', 'r') as file:
    # Read each line in the file
    for line in file:
        # Strip newline characters and print each line
        json_line = json.loads(line)
